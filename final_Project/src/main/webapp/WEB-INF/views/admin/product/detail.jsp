...
<body>
	...
	<footer class="footer_total_detail">	
		...
		<div class="copy-link">
			...
			<span class="footer_span">Contact <strong><a href="salfit.contact@gmail.com"></a></strong> for more information.<a href="${pageContext.request.contextPath}/">[Shop admin]</a></span>
		</div>
	</footer>
</body>
<script>
			...
			success: function (data) {
				...
				for(i = 0; i < data.length; i++){
					...
					postElement.innerHTML = 
						 '<div class="user-info">'
						+'	<img src="${pageContext.request.contextPath}/resources'+data[i].profile_img+'" />'
